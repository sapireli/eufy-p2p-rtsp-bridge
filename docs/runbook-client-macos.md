...
A 30-minute soak of the final binary remains pending. The headless compositor stall's underlying GStreamer scheduling cause and a clean-host Mac service restart from such a stall remain unverified. Keep both in the physical qualification fault matrix.
