...
export function configDiagnostic(error) {
  ...
  const code = yaml ? "CONFIG_YAML_INVALID" : unsupported ? "CONFIG_UNSUPPORTED_KEY" :
  ...
  const remedy = yaml ? "Correct YAML syntax at the reported line; keep secrets in the environment file." :
